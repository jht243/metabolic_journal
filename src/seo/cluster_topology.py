...
_ANCHOR: dict[str, str] = {
    ...
    "/peptides/retatrutide": "Retatrutide peptide: triple agonist weight-loss research, risks, and status",
    ...
    "/compare/aod-9604-vs-hgh-fragment": "AOD-9604 vs HGH Fragment 176-191: are they the same peptide?",
    "/compare/hgh-peptides-vs-hgh": "HGH peptides vs synthetic HGH: which is right for you?",
    "/compare/glp1-vs-peptides": "GLP-1 medications vs weight loss peptides: complete comparison",
    ...
    "/guides/how-to-get-ozempic-for-weight-loss": "How to get prescribed Ozempic for weight loss: eligibility, costs, and safer next steps",
    ...
    "/guides/how-much-deep-sleep-do-you-need": "How much deep sleep do you need? N3 sleep, trackers, and recovery targets",
    "/guides/is-6-hours-of-sleep-enough": "Is 6 hours of sleep enough? Health risks, exceptions, and how to recover",
    ...
    # Blood test interpretation pages
    "/labs/blood-test-results": "How to read blood test results: the complete guide to understanding your lab work",
    "/labs/cbc-blood-test": "CBC blood test: what a complete blood count measures and what your results mean",
    "/labs/mchc-blood-test": "MCHC blood test: meaning, normal range, high and low results",
    "/labs/mcv-blood-test": "MCV blood test: high, low, normal range, and anemia patterns",
    "/labs/hct-blood-test": "HCT blood test: hematocrit levels, high and low results explained",
    "/labs/comprehensive-metabolic-panel": "Comprehensive metabolic panel (CMP): all 14 tests explained with normal ranges",
    "/labs/liver-function-test": "Liver function tests: ALT, AST, ALP, and bilirubin results explained",
    "/labs/kidney-function-test": "Kidney function tests: eGFR, creatinine, BUN, and CKD stages explained",
    "/labs/thyroid-panel": "Thyroid blood test: TSH, free T4, T3 results and what they mean",
    "/labs/luteinizing-hormone": "Luteinizing hormone test: LH levels, fertility, menopause, and low testosterone",
    "/labs/a1c-test": "A1C test: levels chart, what's normal vs prediabetes, and how to lower it",
    "/biomarkers/crp-levels": "CRP and hs-CRP blood test: inflammation levels, cardiovascular risk, and what's normal",
    "/biomarkers/iron-levels": "Iron blood test: ferritin, TIBC, and iron saturation explained",
    "/biomarkers/vitamin-d-levels": "Vitamin D blood test: optimal levels, deficiency symptoms, and updated guidelines",
    "/biomarkers/mpv-blood-test": "MPV blood test: what mean platelet volume means when it's high or low",
    "/biomarkers/wbc-count": "White blood cell count: normal range, low and high WBC causes",
...
CLUSTERS: dict[str, Cluster] = {
    "peptides": Cluster(
        ...
        members=(
            ...
            _ck("/peptides/retatrutide", "Retatrutide peptide research: triple agonist mechanism, trial results, risks, and current availability."),
            ...
            _ck("/compare/aod-9604-vs-hgh-fragment", "AOD-9604 vs HGH Fragment 176-191: naming confusion, history, and what the evidence shows."),
            _ck("/compare/hgh-peptides-vs-hgh", "GH secretagogues vs synthetic HGH: mechanism, cost, safety, and who needs each."),
            _ck("/compare/glp1-vs-peptides", "GLP-1 drugs vs research peptides for weight loss: efficacy, access, and safety compared."),
    ...
    "metabolism": Cluster(
        ...
        members=(
            ...
            _ck("/guides/how-to-get-ozempic-for-weight-loss", "Prescription eligibility, insurance friction, and safer metabolic next steps for Ozempic weight-loss seekers."),
    ...
    "recovery": Cluster(
        ...
        members=(
            ...
            _ck("/guides/how-much-deep-sleep-do-you-need", "Deep sleep targets, tracker limits, and how to improve N3 sleep."),
            _ck("/guides/is-6-hours-of-sleep-enough", "Why six hours is usually not enough sleep and what to do if it is your current reality."),
    ...
    "testing": Cluster(
        ...
        members=(
            ...
            _ck("/labs/blood-test-results", "How to read your blood work — a plain-English guide to every common lab value."),
            _ck("/labs/cbc-blood-test", "CBC explained: RBC, WBC, hemoglobin, hematocrit, platelets, and differentials."),
            _ck("/labs/mchc-blood-test", "MCHC explained: hemoglobin concentration in red blood cells, high/low causes, and next labs."),
            _ck("/labs/mcv-blood-test", "MCV explained: red blood cell size, microcytic vs macrocytic anemia patterns."),
            _ck("/labs/hct-blood-test", "Hematocrit explained: high and low HCT, dehydration, anemia, sleep apnea, and TRT monitoring."),
            _ck("/labs/comprehensive-metabolic-panel", "CMP: 14 tests covering glucose, electrolytes, kidney, liver, and protein."),
            _ck("/labs/liver-function-test", "Liver panel: ALT, AST, ALP, bilirubin — patterns and what elevations mean."),
            _ck("/labs/kidney-function-test", "Kidney function: eGFR, creatinine, BUN, and the 2024 KDIGO CKD stages."),
            _ck("/labs/thyroid-panel", "Thyroid labs: TSH, free T4, T3 — what your results mean and when to retest."),
            _ck("/labs/luteinizing-hormone", "LH levels explained for ovulation, menopause, fertility, and male testosterone signaling."),
            _ck("/labs/a1c-test", "A1C test: levels chart, prediabetes range, and evidence-based ways to lower it."),
            _ck("/biomarkers/crp-levels", "CRP / hs-CRP: inflammation marker, cardiovascular risk tiers, and what to do."),
            _ck("/biomarkers/iron-levels", "Iron panel: ferritin, TIBC, saturation — diagnosing deficiency and overload."),
            _ck("/biomarkers/vitamin-d-levels", "Vitamin D levels: the 2024 Endocrine Society guidelines and what to supplement."),
            _ck("/biomarkers/mpv-blood-test", "MPV: what mean platelet volume reveals about platelet production and disease."),
            _ck("/biomarkers/wbc-count", "White blood cell count: normal range, causes of high and low WBC."),
        ),
    ),
}
...
_CROSS_CLUSTER: dict[str, list[str]] = {
    ...
    "/labs/thyroid-panel": ["testing", "hormones"],
    "/labs/a1c-test": ["testing", "metabolism"],
    "/biomarkers/iron-levels": ["testing", "recovery"],
    "/biomarkers/vitamin-d-levels": ["testing", "hormones"],
    # Peptide ↔ metabolic health cross-links (May 2026 SEO action)
    "/peptides/weight-loss": ["peptides", "metabolism"],
    "/peptides/glp-1": ["peptides", "metabolism"],
    "/peptides/retatrutide": ["peptides", "metabolism"],
    "/peptides/aod-9604": ["peptides", "metabolism"],
    "/guides/glp1-plateau": ["metabolism", "peptides"],
    "/guides/ozempic-weight-loss": ["metabolism", "peptides"],
    "/guides/how-to-get-ozempic-for-weight-loss": ["metabolism", "peptides"],
    "/peptides/nad": ["peptides", "recovery"],
    "/peptides/hgh": ["peptides", "hormones"],
    "/biomarkers/testosterone-by-age": ["testing", "hormones", "peptides"],
    "/tools/insulin-resistance-calculator": ["metabolism", "testing"],
    "/biomarkers/cortisol-levels": ["testing", "hormones", "recovery"],
    "/guides/how-much-deep-sleep-do-you-need": ["recovery", "testing"],
    "/guides/is-6-hours-of-sleep-enough": ["recovery", "metabolism"],
    "/labs/luteinizing-hormone": ["testing", "hormones"],
}
...
_PATH_TO_CLUSTER: tuple[tuple[str, str], ...] = (
    ...
    ("/guides/how-to-get-ozempic-for-weight-loss", "metabolism"),
    ...
    ("/guides/how-much-deep-sleep-do-you-need", "recovery"),
    ("/guides/is-6-hours-of-sleep-enough", "recovery"),
    ...
    ("/labs/blood-test-results", "testing"),
    ("/labs/cbc-blood-test", "testing"),
    ("/labs/mchc-blood-test", "testing"),
    ("/labs/mcv-blood-test", "testing"),
    ("/labs/hct-blood-test", "testing"),
    ("/labs/comprehensive-metabolic-panel", "testing"),
    ("/labs/liver-function-test", "testing"),
    ("/labs/kidney-function-test", "testing"),
    ("/labs/thyroid-panel", "testing"),
    ("/labs/luteinizing-hormone", "testing"),
    ("/labs/a1c-test", "testing"),
    ("/biomarkers/crp-levels", "testing"),
    ("/biomarkers/iron-levels", "testing"),
    ("/biomarkers/vitamin-d-levels", "testing"),
    ("/biomarkers/mpv-blood-test", "testing"),
    ("/biomarkers/wbc-count", "testing"),
    ...
    ("/compare/aod-9604-vs-hgh-fragment", "peptides"),
    ("/compare/hgh-peptides-vs-hgh", "peptides"),
    ("/compare/glp1-vs-peptides", "peptides"),
